...
authRouter.route('/').post(loginLimiter, validate(loginSchema), authController.login);

authRouter.route('/register').post(validate(registerSchema), authController.register);

authRouter.route('/auth0').post(validate(auth0LoginSchema), authController.auth0Login);

authRouter.route('/totp-login').post(validate(totpLoginSchema), authController.totpLogin);
